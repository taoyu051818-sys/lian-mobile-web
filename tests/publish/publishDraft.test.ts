...
import {
  ...
  savePublishDraft,
} from "../../src/platform/publish-draft";
...
describe("publish draft helpers", () => {
  ...
  it("reads back valid stored drafts and clears invalid ones safely", () => {
    ...
    storage.setItem(PUBLISH_DRAFT_SESSION_KEY, JSON.stringify({ title: "", visibility: "everyone" }));
