...
const STRING_CONSTANTS = [
  ...
  "REPLY_SORT_NEWEST",
  "REPLY_SORT_OLDEST",
  // Added post-merge cbbd430: gesture / auth-gate / dialog / aria / filter
  // toggles that ship as part of recent feature merges. Listed at the end
  // so the existing categorical groupings above stay readable.
  ...
  "GESTURE_SWIPE_BOOKMARK",
  "GESTURE_SWIPE_DELETE",
  "GESTURE_SWIPE_MARK_READ",
