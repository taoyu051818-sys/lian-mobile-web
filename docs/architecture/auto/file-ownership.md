...
| File                  | Summary                                                                                                                  | Lines |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------ | ----: |
| `api/admin.ts`        | export type AdminVerificationStatus = "pending" \| "reviewing" \| "approved" \| "rejected";                              |   184 |
...
| `api/messages.ts`     | export function extractChannelMessagePlainText(html?: string): string                                                    |   184 |
...
| File                                | Summary                                                                                                                  | Lines |
| ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ----: |
| `app/AppViewHost.vue`               | `feed` is the cold-start view, so it is intentionally eager-imported — first                                             |    53 |
...
| `app/view-types.ts`                 | export type AppViewKey =                                                                                                 |    67 |
...
| `config/brand/merchant.ts`     | export const MERCHANT_BLOCK_LABEL = "商家信息"; export const MERCHANT_CATEGORY_FOOD = "餐饮"; export const MERCHANT_CATEGOR...                        |    64 |
...
| `features/admin/AdminVerificationQueueList.vue`  | Vue SFC                                                                                                                  |   294 |
| `features/admin/AdminView.vue`                   | Vue SFC                                                                                                                  |   232 |
...
| `features/admin/useAdminConsole.ts`              | export function useAdminConsole({ token, onTokenInvalid }: UseAdminConsoleOptions)                                       |   214 |
...
| `features/detail/PostDetailContent.vue`          | Vue SFC                                                                                                                  |   182 |
...
| `features/detail/PostDetailMerchantBlock.vue`    | `errandEntryAvailable === false` is the unavailable case (the merchant                                                   |   280 |
| `features/detail/PostDetailPanel.vue`            | Shell chrome slots (`top: detail-topbar`, `bottom: reply-dock`) are now                                                  |   552 |
...
| `features/messages/MessagesView.vue`             | Vue SFC                                                                                                                  |   180 |
| `features/messages/NotificationList.vue`         | Vue SFC                                                                                                                  |   149 |
...
| `types/messages.ts`        | Client-generated nonce stamped on the optimistic item so we can match the server echo back to it without depending on...  |    68 |
