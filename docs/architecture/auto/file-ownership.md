...
| `features/publish/PublishView.vue`              | Vue SFC                                                                                                                 |   272 |
...
| `features/publish/usePublishDraft.ts`           | export function usePublishDraft()                                                                                       |   263 |
...
| File                       | Summary                                                                                                                  | Lines |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ----: |
| `locales/en.ts`            | English locale (PRD V0.1 §9). Mirrors zh-CN keys 1:1 — every flatten key in src/locales/zh-CN.ts must exist here too,... |   382 |
