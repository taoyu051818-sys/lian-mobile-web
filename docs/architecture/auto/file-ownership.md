...
| `api/posts.ts`    | export interface PostLikeResponse                                                                                        |   122 |
| `api/profile.ts`  | TypeScript module                                                                                                        |    69 |
| `api/publish.ts`  | Creates a display-only fallback draft from free-text place name. When `placeName` is non-empty the source is "manual"... |   213 |
...
| `config/brand/detail.ts`       | export const POST_DETAIL_CLOSE = "关闭详情"; export const POST_DETAIL_AUTHOR_AVATAR = "作者头像"; export const POST_DETAIL_SH...                      |    64 |
...
| `config/brand/publish.ts`      | export const PUBLISH_CLEAR = "清空"; export const PUBLISH_SUBMIT = "发布"; export const PUBLISH_LOCATION_LABEL = "地点"; e...                         |    69 |
...
| `features/detail/PostDetailContent.vue`         | Vue SFC                                                                                                                 |   104 |
...
| `features/detail/PostDetailPanel.vue`           | Vue SFC                                                                                                                 |   328 |
...
| `features/map/MapCanvas.vue`                    | Vue SFC                                                                                                                 |   190 |
| `features/map/MapLeafletView.vue`               | Vue SFC                                                                                                                 |   138 |
...
| `features/publish/PublishMetaControls.vue`      | Vue SFC                                                                                                                 |   203 |
| `features/publish/PublishResetConfirm.vue`      | Vue SFC                                                                                                                 |    59 |
| `features/publish/PublishView.vue`              | Vue SFC                                                                                                                 |   270 |
...
| `features/publish/usePublishDraft.ts`           | export function usePublishDraft()                                                                                       |   248 |
...
| File               | Summary                         | Lines |
| ------------------ | ------------------------------- | ----: |
| `locales/index.ts` | export const i18n = createI18n( |    14 |
| `locales/zh-CN.ts` | TypeScript module               |   374 |
...
| File                          | Summary                                                                                                                 | Lines |
| ----------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ----: |
| `platform/api-normalizers.ts` | export function asRecord(value: unknown): JsonRecord                                                                    |   118 |
...
| File                | Summary                                                                                                                   | Lines |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------- | ----: |
| `types/feed.ts`     | export type FeedItemId = number;                                                                                          |    59 |
...
| `types/post.ts`     | export interface PostReply                                                                                                |    31 |
| `types/profile.ts`  | export type ProfileTabKey = "history" \| "saved" \| "liked";                                                              |    42 |
| `types/publish.ts`  | export type PublishMapVersion = "legacy" \| "manual" \| "gaode_v2"; export interface PublishLocationDraft { source: Pu... |    55 |
