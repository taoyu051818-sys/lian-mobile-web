...
| `features/detail/PostDetailMerchantBlock.vue`    | Import directly from the route module instead of `../errand` so the detail                                                    |   305 |
| `features/detail/PostDetailPanel.vue`            | Shell chrome slots (`top: detail-topbar`, `bottom: reply-dock`) are now                                                       |   553 |
...
| `features/errand/ErrandOrderTimelineView.vue`    | Vue SFC                                                                                                                       |   329 |
| `features/errand/ErrandOrderView.vue`            | When the merchant CTA opens this view a second time for a different post,                                                     |   447 |
| `features/errand/ProfileErrandOrdersBlock.vue`   | Vue SFC                                                                                                                       |   262 |
...
| `features/errand/useErrandOrderRoute.ts`         | Singleton routing context for the errand-order secret view. The order flow is a multi-screen detour from the merchan...       |    45 |
