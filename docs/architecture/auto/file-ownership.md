...
## src/features/ (165 files)

| File                                               | Summary                                                                                                                       | Lines |
| -------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | ----: |
| `features/admin/AdminAuditBlock.vue`               | Vue SFC                                                                                                                       |    40 |
...
| `features/admin/AdminReportsBlock.vue`             | Vue SFC                                                                                                                       |    57 |
| `features/admin/AdminTokenGate.vue`                | Vue SFC                                                                                                                       |   105 |
| `features/admin/AdminUserActionPanel.vue`          | Vue SFC                                                                                                                       |   115 |
| `features/admin/AdminVerificationBlock.vue`        | Vue SFC                                                                                                                       |   391 |
| `features/admin/AdminView.vue`                     | Vue SFC                                                                                                                       |   304 |
| `features/admin/admin-format.ts`                   | export function adminStatusLabel(status: AdminReportStatus \| string): string                                                 |    39 |
| `features/admin/admin-verification.ts`             | export type                                                                                                                   |   168 |
| `features/admin/index.ts`                          | TypeScript module                                                                                                             |    12 |
