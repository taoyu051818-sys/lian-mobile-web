...
| `config/brand/index.ts`        | TypeScript module                                                                                                                                     |    20 |
...
| `config/brand/trade.ts`        | export const TRADE_BLOCK_LABEL = "二手交易"; export const TRADE_PRICE_LABEL = "价格"; export const TRADE_CATEGORY_LABEL = "...                        |    16 |
...
| `features/detail/PostDetailContent.vue`         | Vue SFC                                                                                                                  |   177 |
