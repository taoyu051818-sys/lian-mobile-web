...
| `api/posts.ts`       | export interface PostLikeResponse                                                                                        |   132 |
...
| `config/brand/detail.ts`       | export const POST_DETAIL_CLOSE = "关闭详情"; export const POST_DETAIL_AUTHOR_AVATAR = "作者头像"; export const POST_DETAIL_SH...                      |   103 |
...
| `features/detail/PostDetailContent.vue`         | Vue SFC                                                                                                                  |   139 |
...
| `features/detail/PostDetailPanel.vue`           | V0.1 surface — backend authoritative for action permission. The publish                                                  |   432 |
...
| File                       | Summary                                                                                                                  | Lines |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ----: |
| `locales/en.ts`            | English locale (PRD V0.1 §9). Mirrors zh-CN keys 1:1 — every flatten key in src/locales/zh-CN.ts must exist here too,... |   428 |
...
| `locales/zh-CN.ts`         | TypeScript module                                                                                                        |   416 |
...
| `types/post.ts`            | event?: EventPostExtension; eventJoined?: boolean; help?: HelpPostExtension; helpVoted?: boolean; } Unified PostType...   |   117 |
