...
| `api/posts.ts`       | export interface PostLikeResponse                                                                                        |   127 |
...
| `config/brand/detail.ts`       | export const POST_DETAIL_CLOSE = "关闭详情"; export const POST_DETAIL_AUTHOR_AVATAR = "作者头像"; export const POST_DETAIL_SH...                      |    85 |
...
| `config/brand/index.ts`        | TypeScript module                                                                                                                                     |    16 |
...
| `config/brand/publish.ts`      | export const PUBLISH_CLEAR = "清空"; export const PUBLISH_SUBMIT = "发布"; export const PUBLISH_LOCATION_LABEL = "地点"; e...                         |    74 |
...
| `features/detail/PostDetailContent.vue`         | Vue SFC                                                                                                                  |   121 |
...
| `features/detail/PostDetailPanel.vue`           | V0.1 surface — backend authoritative for action permission. The publish                                                  |   385 |
| `features/detail/PostDetailTopbar.vue`          | Vue SFC                                                                                                                  |   154 |
| `features/detail/PostPlaceSheetBlock.vue`       | Vue SFC                                                                                                                  |   192 |
| `features/detail/PostReplies.vue`               | Vue SFC                                                                                                                  |   102 |
| `features/detail/PostReplyDock.vue`             | Vue SFC                                                                                                                  |   166 |
...
| `features/feed/FeedView.vue`                    | Detail lifecycle composable                                                                                              |   261 |
...
| `features/feed/useDetailCardifyMotion.ts`       | Start the return-to-card animation. Returns a promise that resolves when the animation duration has elapsed.             |   141 |
| `features/feed/useDetailDragGesture.ts`         | export function useDetailDragGesture(deps:                                                                               |   110 |
...
| `features/publish/usePublishSubmit.ts`          | export function usePublishSubmit(options:                                                                                |    81 |

## src/locales/ (4 files)

| File                       | Summary                                                                                                                  | Lines |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ----: |
| `locales/en.ts`            | English locale (PRD V0.1 §9). Mirrors zh-CN keys 1:1 — every flatten key in src/locales/zh-CN.ts must exist here too,... |   410 |
...
| `locales/zh-CN.ts`         | TypeScript module                                                                                                        |   398 |
...
| File                          | Summary                                                                                                                  | Lines |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ----: |
| `platform/api-normalizers.ts` | Coerce a raw payload into an EventPostExtension. Returns undefined when the payload does not look like an event (no e... |   230 |
...
| `shell/floatingChromeState.ts` | export type ChromePhase = "idle" \| "opening" \| "open" \| "dragging" \| "returning";                                      |    29 |
| `shell/index.ts`               | export type                                                                                                                |    25 |
| `shell/page-model.ts`          | export interface PageChromeTopSpec                                                                                         |    28 |
| `shell/shell-chrome-types.ts`  | slot?: string; tabs?: ChromeTabSpec \| null; filters?: ChromeFilterSpec[]; identity?: ChromeIdentitySpec \| null; onTab... |    72 |
| `shell/shell-chrome.css`       | Stylesheet                                                                                                                 |   221 |
...
| `styles/content-immersive-ui.css` | Stylesheet |   108 |
| `styles/floating-chrome.css`      | Stylesheet |    31 |
| `styles/lian-tokens.css`          | Stylesheet |   107 |
...
| `types/post.ts`            | event?: EventPostExtension; eventJoined?: boolean; } Unified PostType vocabulary (PRD V0.1 §6.1). - data model (s...      |   113 |
...
| File            | Summary           | Lines |
| --------------- | ----------------- | ----: |
| `vite-env.d.ts` | TypeScript module |     8 |
