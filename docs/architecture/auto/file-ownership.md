...
| File                  | Summary                                                                                                                  | Lines |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------ | ----: |
| `api/admin.ts`        | TypeScript module                                                                                                        |   257 |
...
| File                           | Summary                                                                                                                                               | Lines |
| ------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ----: |
| `config/brand/admin.ts`        | export const ADMIN_SECTION_LABEL = "管理后台"; export const ADMIN_ENTER_LABEL = "管理"; export const ADMIN_EXIT_LABEL = "退出...                      |    97 |
...
| `features/admin/AdminVerificationQueueList.vue`  | Vue SFC                                                                                                                       |   414 |
| `features/admin/AdminView.vue`                   | Vue SFC                                                                                                                       |   249 |
| `features/admin/admin-format.ts`                 | export function adminStatusLabel(status: AdminReportStatus \| string): string                                                 |    39 |
| `features/admin/index.ts`                        | TypeScript module                                                                                                             |    10 |
| `features/admin/useAdminConsole.ts`              | export function useAdminConsole({ token, onTokenInvalid }: UseAdminConsoleOptions)                                            |   256 |
...
| File                       | Summary                                                                                                                   | Lines |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------- | ----: |
| `types/admin.ts`           | export type AdminReportStatus =                                                                                           |   102 |
