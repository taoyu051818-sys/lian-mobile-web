...
| File              | Summary                                                                                                                  | Lines |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------ | ----: |
| `entry-server.ts` | SSR contract entry. Phase 1.1a only ships the function shape — calling it renders the current `App.vue` to HTML, whic... |    21 |

## src/features/ (170 files)
>>>>>>> 6c7501859287e552bc73fa7967a1f05e7ecc989c
