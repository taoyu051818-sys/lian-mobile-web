...
| File                          | Summary                                                                                                                  | Lines |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ----: |
| `app/AppViewHost.vue`         | `feed` is the cold-start view, so it is intentionally eager-imported — first                                             |    51 |
...
| File                          | Summary                                                                                                                  | Lines |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ----: |
| `platform/api-normalizers.ts` | Coerce to a non-negative integer, defaulting to 0. Convenience wrapper for the count/capacity fields backends sometim... |   231 |
...
| `shell/useShellChrome.ts`      | Per-region slot stack. The top of each stack is what ShellChrome renders. `setRegion({ slot })` writes the stack base... |   126 |
