...
| `features/detail/PostDetailContent.vue`            | Issue #785 — single capability lookup. The view used to ladder                                                                |   275 |
...
| `features/detail/PostDetailPanel.vue`              | Vue SFC                                                                                                                       |   399 |
...
| `features/detail/postActionRegistry.ts`            | Post detail action registry (issue #793, follow-up to #785/#788). Single canonical lookup for which post-detail acti...       |   236 |
