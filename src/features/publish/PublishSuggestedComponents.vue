...
const KIND_ICON: Record<SuggestedComponentKind, string> = {
  ...
  event_time: PUBLISH_SUGGESTED_KIND_ICON_EVENT_TIME,
  price: PUBLISH_SUGGESTED_KIND_ICON_PRICE,
  merchant_info: PUBLISH_SUGGESTED_KIND_ICON_MERCHANT_INFO,
  trade_condition: PUBLISH_SUGGESTED_KIND_ICON_TRADE_CONDITION,
  help_tag: PUBLISH_SUGGESTED_KIND_ICON_HELP_TAG,
};
