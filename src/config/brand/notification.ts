...
export const NOTIFICATION_REPLY_INBOX_HINT =
  "别人回复你的帖子或评论后，会集中出现在这里。";
...
export const NOTIFICATION_SYSTEM_INBOX_HINT =
  "认证结果、活动状态和审核反馈会逐步汇总到这里。";
...
export const NOTIFICATION_ORDER_INBOX_HINT =
  "跑腿、配送和争议相关的状态变更会在这里集中提醒。";
