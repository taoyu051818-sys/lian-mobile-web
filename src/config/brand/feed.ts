...
export const GESTURE_CONTEXT_UNBOOKMARK = "取消收藏";
export const GESTURE_CONTEXT_REPORT = "前往详情举报";
export const FEED_BOOKMARK_SAVED = "已加入收藏。";
export const FEED_BOOKMARK_REMOVED = "已取消收藏。";
