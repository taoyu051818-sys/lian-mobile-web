...
export const GROUPBUY_VIEWER_STATUS_LABEL = "我的状态";
export const GROUPBUY_VIEWER_STATUS_JOINED = "已参与";
export const GROUPBUY_VIEWER_STATUS_NOT_JOINED = "未参与";
export const GROUPBUY_VIEWER_STATUS_CREATOR = "发起人";
export const GROUPBUY_PAYMENT_STATUS_LABEL = "支付状态";
export const GROUPBUY_PAYMENT_STATUS_UNPAID = "待支付";
export const GROUPBUY_PAYMENT_STATUS_PENDING = "支付确认中";
export const GROUPBUY_PAYMENT_STATUS_PAID = "已支付";
export const GROUPBUY_PAYMENT_STATUS_REFUNDED = "已退款";
