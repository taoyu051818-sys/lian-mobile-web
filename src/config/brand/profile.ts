...
export const PROFILE_TAB_POSTS = "发帖";
export const PROFILE_TAB_REPLIES = "回复";
export const PROFILE_TAB_DRAFTS = "草稿";
export const PROFILE_TAB_MAP_CONTRIBUTIONS = "地点";
...
export const PROFILE_ALIAS_EMPTY = "暂无可用官方马甲，当前使用真实身份发布。";

/** 头像编辑 */
export const PROFILE_AVATAR_TITLE = "头像";
export const PROFILE_AVATAR_CROP_HINT = "拖拽调整位置，捏合或滑块缩放";
export const PROFILE_AVATAR_CROP_ALT = "头像裁剪预览";
export const PROFILE_AVATAR_SELECT = "选择头像图片";
export const PROFILE_AVATAR_RESELECT = "重新选择图片";
export const PROFILE_AVATAR_SCALE = "缩放";
export const PROFILE_AVATAR_SCALE_ARIA = "头像缩放比例";
export const PROFILE_AVATAR_FILE_INPUT_ARIA = "选择头像图片文件";
export const PROFILE_AVATAR_SAVE = "保存头像";
