 ...
 * configures the right-menu share (updateAppMessageShareData /
 * updateTimelineShareData) so that sharing via the menu shows a rich card
 * with title, description, and cover image.
 *
 * Outside WeChat the module is a no-op.
 */
