...
const lanes = [
  { key: "channel", label: "频道", description: "校园频道入口，后续接入真实列表。", status: "Vue" },
  { key: "notice", label: "通知", description: "回复、收藏和系统提醒会在这里聚合。", status: "Next" },
  { key: "archive", label: "归档", description: "历史信息入口，方便搜索和沉淀。", status: "Ready" }
] as const;
</script>
...
<template>
  <section class="messages-view" aria-labelledby="messages-view-title">
    <GlassPanel class="messages-view__card">
      ...
      <p>Messages 已切到 Vue View。下一步接入真实数据和状态。</p>
